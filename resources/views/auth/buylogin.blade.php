    ...
    <div class="container mt-5 pt-5">
        <div class="row justify-content-center"> <!--セルのセンター合わせ-->
            <div class="col-md-8"> <!--col=最大幅 col-*=auto col-sm=540px col-md=720px col-lg=960px col-xl=1140px    カラムは全部で12(md-8は8/12ということ)-->
                <div class="card">　　　　　　　　　　　　　　　　
                    <div class="card-header"><h4>{{ __('バイログイン') }}</h4><p>会員の方は、登録時に入力されたメールアドレスとパスワードでログインしてください。</p></div> <!-- __( $string ) の意味  _2つの __ 関数は、Lang::get の別名、PHPの言語機能では無く、国際化対応のために作成された関数で -->
                    
                        
                        <div class="card-body">        <!-- {{ route('login') }}は定数 -->
                           <form method="post" action="{{ route('buylogin') }}" name="login"> <!-- action属性=フォームで入力したdataの送信先URIを指定する、、 method属性=指定requiedはない-->
